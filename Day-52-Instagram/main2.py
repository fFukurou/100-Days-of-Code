...
USERNAME = os.environ["INSTAGRAM_EMAIL"]
PASSWORD = os.environ["INSTAGRAM_PASSWORD"]
 
instagram_login = 'https://www.instagram.com/'
similar_account = os.environ["TARGET_ACCOUNT"]
...
class InstaFollower:
    ...
    def follow(self):
        follower_count = int(self.driver.find_elements(By.CLASS_NAME, '_ac2a')[1].get_attribute('title').replace(',','')) #type: ignore
